...
class BookingShowTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->booking = Booking::factory()->for($this->user)->create();
    }

    public function testBookingShowReturnsCorrectResponse(): void
    {
        $response = $this->getJson(route('api.bookings.show', $this->booking));
    ...
    public function testBookingShowDoesNotReturn(): void
    {
        $user = User::factory()->create();
        $response = $this->actingAs($user)->getJson(route('api.bookings.show', $this->booking));
